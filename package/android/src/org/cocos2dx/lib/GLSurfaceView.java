...
//import dk.logisoft.trace.CustomExceptionHandler;
//import dk.logisoft.util.LogTimer;
//import dk.logisoft.util.LogUtil;
//import dk.logisoft.util.Logs;
...
public class GLSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private class EglHelper {
            ...
            if (!mEgl.eglSwapBuffers(mEglDisplay, mEglSurface)) {
                ...
                switch (error) {
                    ...
                    case EGL10.EGL_SUCCESS:
                        Log.e("EglHelper", "eglSwapBuffers returned false without errcode, ignore this");
                        break;
                    default:
        ...
        private void reportEglException(final String errorMsg) {
            //CustomExceptionHandler.reportCaughtException(new IllegalStateException(errorMsg));
            Log.e(TAG, errorMsg);
        }
    ...
    private class GLThread extends Thread {
        ...
        private void guardedRun() throws InterruptedException, StopGlThreadException {
            ...
            try {
                ...
                while (true) {
                    //LogTimer.incrementFrameCounter();
                    //LogTimer.rootCheckPoint();
                    //LogTimer.startTimer(Logs.glsurfaceviewOneRunLoop);
                    synchronized (sGLThreadManager) {
                        //LogTimer.startTimer(Logs.glsurfaceviewsynchronized);
                        while (true) {
                            if (mShouldExit) {
                                return;
                            }
                            ...
                            if (LOG_THREADS)
                                Log.i(TAG, "GLThread.guardedRun(): waiting tid=" + getId()
                                        ...
                                        + (mRenderMode == RENDERMODE_CONTINUOUSLY));
                            //LogTimer.startTimer(Logs.glsurfaceviewsynchronizedWait);
                            sGLThreadManager.wait();
                            //LogTimer.stopTimer(Logs.glsurfaceviewsynchronizedWait);
                        }
                        //LogTimer.stopTimer(Logs.glsurfaceviewsynchronized);
                    ...
                    //LogTimer.stopTimer(Logs.glsurfaceviewOneRunLoop);
                }
