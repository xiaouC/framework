...
extern "C"
{
    ...
    void preloadBackgroundMusicJNI(const char *path, bool alterMusicPlayer)
    {
        // void playBackgroundMusic(String,boolean)
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "preloadBackgroundMusic1" : "preloadBackgroundMusic", "(Ljava/lang/String;)V"))
        {            
            return;
        }
    ...
    void playBackgroundMusicJNI(const char *path, bool isLoop, bool alterMusicPlayer)
    {
        // void playBackgroundMusic(String,boolean)
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "playBackgroundMusic1" : "playBackgroundMusic", "(Ljava/lang/String;Z)V"))
        {
            return;
        }
    ...
    void stopBackgroundMusicJNI(bool alterMusicPlayer)
    {
        // void stopBackgroundMusic()
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "stopBackgroundMusic1" : "stopBackgroundMusic", "()V"))
        {
            return;
        }
    ...
    void pauseBackgroundMusicJNI(bool alterMusicPlayer)
    {
        // void pauseBackgroundMusic()
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "pauseBackgroundMusic1" : "pauseBackgroundMusic", "()V"))
        {
            return;
        }
    ...
    void resumeBackgroundMusicJNI(bool alterMusicPlayer)
    {
        // void resumeBackgroundMusic()
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "resumeBackgroundMusic1" : "resumeBackgroundMusic", "()V"))
        {
            return;
        }
    ...
    void rewindBackgroundMusicJNI(bool alterMusicPlayer)
    {
        // void rewindBackgroundMusic()
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "rewindBackgroundMusic1" : "rewindBackgroundMusic", "()V"))
        {
            return;
        }
    ...
    bool isBackgroundMusicPlayingJNI(bool alterMusicPlayer)
    {
        ...
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "isBackgroundMusicPlaying1" : "isBackgroundMusicPlaying", "()Z"))
        {
            return ret;
        }
    ...
    float getBackgroundMusicVolumeJNI(bool alterMusicPlayer)
    {
        ...
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "getBackgroundMusicVolume1" : "getBackgroundMusicVolume", "()F"))
        {
            return ret;
        }
    ...
    void setBackgroundMusicVolumeJNI(float volume, bool alterMusicPlayer)
    {
        // void setBackgroundMusicVolume()
        
        JniMethodInfo methodInfo;
        
        if (! getStaticMethodInfo(methodInfo, alterMusicPlayer ?  "setBackgroundMusicVolume1" : "setBackgroundMusicVolume", "(F)V"))
        {
            return ;
        }
